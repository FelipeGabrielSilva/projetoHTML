    ...
    <Flex w="100%" h="auto" bg="#427D9D">
      ...
      >
        <Cartao
          ...
          pagina="/AnaliseDados/"
          etiqueta="Analytics" etiquetaCor="purple"
        />
        <Cartao
          ...
          pagina="/IntroducaoASQL/"
          etiqueta="Python" etiquetaCor="green"
        />
        <Cartao
          ...
          pagina="/IntroducaoAPowerBI/"
          etiqueta="power bi" etiquetaCor="orange"
        />
        <Cartao
          ...
          pagina="/IntroducaoAoPythonProgramacao/"
          etiqueta="sql" etiquetaCor="yellow"
        />
      </Box>
    </Flex>
  );
